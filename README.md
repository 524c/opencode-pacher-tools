...
**7 patches** organized by category. All patches are **independent** and can be enabled/disabled individually.
...
- **summarization-enhancement-p1** - Agent context preservation across summarization

**Note**: While these patches work together conceptually (P0 and P1 enhance agents-md-enforcement), they apply independently and can be used standalone.
